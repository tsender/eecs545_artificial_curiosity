...
def create_network32():
    ...
    # Encoder
    e = tf.keras.layers.Conv2D(32, (3,3), padding='same', activation='relu', kernel_initializer=tf.initializers.he_normal())(in_image)
    e = tf.keras.layers.Conv2D(64, (3,3), padding='same', activation='relu', kernel_initializer=tf.initializers.he_normal())(e)
    ...
    e = tf.keras.layers.Dense(128, activation='relu')(e)
    e = tf.keras.layers.Dense(16, activation='relu')(e)

    # Decoder
    d = tf.keras.layers.Dense(16, activation='relu')(e)
    d = tf.keras.layers.Dense(128, activation='relu')(d)
    d = tf.keras.layers.Dense(512, activation='relu')(d)
    d = tf.keras.layers.Dense(8*8*64, activation='relu')(d)
    d = tf.keras.layers.Reshape((8,8,64))(d)
    d = tf.keras.layers.UpSampling2D()(d) # Shape (B, 16, 16, 64)
    d = tf.keras.layers.Conv2D(64, (3,3), padding='same', activation='relu', kernel_initializer=tf.initializers.he_normal())(d)
...
def create_network64():
    ...
    e = tf.keras.layers.Conv2D(64, (3,3), padding='same', activation='relu', kernel_initializer=tf.initializers.he_normal())(e)
    e = tf.keras.layers.AveragePooling2D()(e) # Shape (B, 16, 16, 64)
    e = tf.keras.layers.Conv2D(128, (3,3), padding='same', activation='relu', kernel_initializer=tf.initializers.he_normal())(e)
    ...
    d = tf.keras.layers.Dense(128, activation='relu')(d)
    d = tf.keras.layers.Dense(512, activation='relu')(d)
    d = tf.keras.layers.Dense(8*8*128, activation='relu')(d)
    d = tf.keras.layers.Reshape((8,8,128))(d)
    d = tf.keras.layers.UpSampling2D()(d) # Shape (B, 16, 16, 128)
    d = tf.keras.layers.Conv2D(128, (3,3), padding='same', activation='relu', kernel_initializer=tf.initializers.he_normal())(d)
...
def create_network128():
    ...
    e = tf.keras.layers.Conv2D(32, (3,3), padding='same', activation='relu', kernel_initializer=tf.initializers.he_normal())(e)
    e = tf.keras.layers.AveragePooling2D()(e) # Shape (B, 32, 32, 32)
    e = tf.keras.layers.Conv2D(64, (3,3), padding='same', activation='relu', kernel_initializer=tf.initializers.he_normal())(e)
    e = tf.keras.layers.AveragePooling2D()(e) # Shape (B, 16, 16, 64)
    e = tf.keras.layers.Conv2D(128, (3,3), padding='same', activation='relu', kernel_initializer=tf.initializers.he_normal())(e)
    ...
    # Decoder
    d = tf.keras.layers.Dense(32, activation='relu')(e)
    d = tf.keras.layers.Dense(128, activation='relu')(d)
    d = tf.keras.layers.Dense(512, activation='relu')(d)
    d = tf.keras.layers.Dense(8*8*128, activation='relu')(d)
    d = tf.keras.layers.Reshape((8,8,128))(d)
